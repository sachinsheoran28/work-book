 	...
 	class SpreadsheetReader_XLS implements Iterator, Countable
	{
		...
		public function ChangeSheet($Index)
		{
			...
			if (isset($this -> Sheets[$Index]))
			{
				...
				//new code by another developer on 08-03-2017
				$f_url = explode('/',$_SERVER['REQUEST_URI']);
				$controller_name = $f_url[4];
				if($controller_name == 'inventory' || $controller_name == 'Inventory' || $controller_name == 'import'){
