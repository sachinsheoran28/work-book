      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
				<li><a href="javascript:void(0);"><i class="icon-dashboard"></i> Inventory</a></li>
                ...
                <tbody>
                    <?php foreach($list as $key => $ass){
                      if($ass["ins_delete"] == 'Y'){
                        ...
                        echo '<td><a href="'. base_url().'home/get_ques/'.$ass["insid"].'" class="btn btn-xs btn-warning">View Inventory Question</a></td>';
                        echo '</tr>';
                      }
                      }   
                     ?>
