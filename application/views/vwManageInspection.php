...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Inspection <small>Manage Inspection</small></h1>
            <ol class="breadcrumb">
				<li><a href="javascript:void(0);"><i class="icon-dashboard"></i> Inspection</a></li>
				<li class="active"><i class="icon-file-alt"></i> Inspection</li>
                ...
                <tbody>
                    <?php foreach($list as $key => $ass){
                      if($ass["ins_delete"] == 'Y'){
                        ...
                        echo '<td><a href="'. base_url().'home/get_inspection_ques/'.$ass["insid"].'" class="btn btn-xs btn-warning">View Inspection Question</a></td>';
                        echo '</tr>';
                      }
                      }   
                     ?>
