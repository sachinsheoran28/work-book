...
<div id="page-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    <i class="fa fa-globe"></i> Inventry Inspection
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="<?php echo site_url('stock/pdfreport/' . $list->rid); ?>">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach (explode(",", $list->scores) as $k => $score) {
                            ...
                            <tr>
                                <td><?= $k + 1 ?></td>
                                <td> <?php echo $ques[$k]['code']; ?> </td>
                                <td> <?php echo $ques[$k]['question']; ?> </td>
                                <td>
                                    <?php if (strlen(explode('~', $list->images)[$k]) > 3) { ?>
                                        <a href="https://www.glocalthinkers.in/uploads/image/<?php echo explode('~', $list->images)[$k]; ?>" class="magnifier" >
                                            <img src="https://www.glocalthinkers.in/uploads/image/<?php echo explode('~', $list->images)[$k]; ?>" width=75 height=75 />
                                        </a>
                                    <?php } ?>
                                </td>
                                <td><?php echo number_format(($score - explode(",", $list->scores2)[$k]), 2); ?></td>
