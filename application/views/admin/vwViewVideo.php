...
<div id="map" style="height:400px;width:600px;"></div>
    ...
    <div id="capture"></div>
          ...
          <div class="row">
				...
				<?php if(file_exists("uploads/video/".$list->vid_url)) {?>	
				<video width="400" controls>
					<!--<source src="http://glocalthinkers\uploads\video/<?php echo $list-> vid_url; ?>" type="video/webm">-->
					<source src="<?php echo $base_url?>uploads/video/<?php echo $list->vid_url; ?>" type="video/webm">
				</video>
				<?php } else{ ?> 
					<img src="<?php echo $base_url;?>uploads/video/no-video1.jpg" style="min-widht:75px; min-height:75px;" />
				<?php } ?>
              </div>
