...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Assets <small><?php echo $result;?></small></h1>
            <ol class="breadcrumb">
              <li><a href="index"><i class="icon-dashboard"></i> Assets</a></li>
              <li class="active"><i class="icon-file-alt"></i>Add Assets</li>
...
if(isset($succ) && $succ !='') {
        ?>
                    <div class="alert alert-success">
                        <?php echo $succ; ?>
                        <a href="index" class="btn btn-sm btn-success">Go back</a> <a href="<?php echo base_url(); ?>admin/assets/add_ins" class="btn btn-sm btn-warning">Add more Assets inspection</a>
                    </div>
        <?php
        }
        ?>
...
?>
                        ...
                        <div class="form-group">
                                <label>Assets Inpection Title </label>
                        ...
                        <div class="form-group">
                                <button class="btn btn-lg btn-primary btn-block" type="submit">Add Assets</button>
                          </div>
                    </form>
                </div>
