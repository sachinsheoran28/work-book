        ...
        ?>
                    <form class="form-signin panel" method="post" action="">
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control" name="option_D_score" value="<?= set_value('option_D_score') ?>">
                          </div>
                        <div class="form-group">
                                <label>Maximum score</label>
                                <input class="form-control" name="max_score" value="<?= set_value('max_score') ?>">
                          </div>
                        <div class="form-group">
                                <label>Weight</label>
                                <input class="form-control" name="weight" value="<?= set_value('weight') ?>">
                          </div>
                        <div class="form-group">
