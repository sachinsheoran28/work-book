      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="<?php echo base_url('admin/checklist/get_ques/'.$parent); ?>"><i class="icon-dashboard"></i> Questions</a></li>
        ...
        ?>
                    <form class="form-signin panel" method="post" action="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                                <label>Weight</label>
                                <input class="form-control" name="weight" value="<?php echo $list->weight; ?>">
                          </div>
                        <div class="form-group">
