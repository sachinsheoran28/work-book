      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="Questions"><i class="icon-dashboard"></i> Assets</a></li>
              <li class="active"><i class="icon-file-alt"></i> Assets</li>
              
              
              <a class="btn btn-primary" href="<?php echo site_url('admin/Assets/add_assets') ?>" style="float:right;">Add New Assets Inspection</a>
                    ...
                    <?php
                     ...
                     if (empty($list)) {
                      ...
                      if($ass["ins_delete"] == 'N'){
                        ...
                        echo '<td><a href="'. base_url().'admin/assets/edit_ins/'.$ass["insid"].'" class="btn btn-xs btn-success">edit</a>   <a href="'. base_url().'admin/assets/get_ques/'.$ass["insid"].'" class="btn btn-xs btn-warning">add Assets Question</a>  <a href="'. base_url().'admin/assets/delete_ins/'.$ass["insid"].'" class="btn btn-xs btn-danger">delete</a></td>';
                        echo '</tr>';
                      }
                       }   }
                     ?>
