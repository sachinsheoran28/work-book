...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1>Results <small>Manage Asset Results</small></h1>
            <ol class="breadcrumb">
                <li><a href="assetsresults"><i class="icon-dashboard"></i> Results</a></li>
                <li class="active"><i class="icon-file-alt"></i> Asset Results List</li>
    ...
    <div class="table-responsive">
        <table class="table table-hover tablesorter">
            ...
            <tbody>
                ...
                if (empty($list)) {
                           echo '<tr>';
                           echo '<td colspan="4">Not Assets Resluts Found.</td>';
                            echo '</tr>';
                       } else { $limit++;
                    foreach ($list as $key => $ass) {
                        ...
                        echo '<td>' . $ass["date"] . '</td>';
                        if ($ass['pending'] == '0') {
                            echo '<td><a href="' . base_url() . 'admin/assetsresults/view_result/' . $ass["rid"] . '" class="btn btn-xs btn-success">View</a> <a href="' . base_url() . 'admin/assetsresults/report_result/' . $ass["rid"] . '" class="btn btn-xs btn-warning">Approve</a>  </td>';
                        } else {
                            echo '<td><a href="' . base_url() . 'admin/assetsresults/view_result/' . $ass["rid"] . '" class="btn btn-xs btn-success">View</a> Report Approved</td>';
                        }
                        echo '</tr>';
                    }
                }
