...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Results <small>Video Lists</small></h1>
            <ol class="breadcrumb">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3>Search Result</h3>
					<form method="post" class="clearfix" action="<?php echo site_url('admin/videos');?>">
              ...
              <table class="table table-hover tablesorter">
                ...
                <tbody>
                    <?php foreach($list as $key => $ass){
                        ...
                        echo '<td><a href="'. base_url().'admin/videos/view_video/'.$ass["vid"].'" class="btn btn-xs btn-success">View</a>  </td>';
                        echo '</tr>';
                      }   
                     ?>
                </tbody>
