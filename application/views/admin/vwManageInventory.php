...
?>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Inventory <small>Manage Inventory Inspection</small></h1>
            <ol class="breadcrumb">
              <li><a href="Questions"><i class="icon-dashboard"></i> Inventory</a></li>
              <li class="active"><i class="icon-file-alt"></i> Inventory</li>
              
              
              <a class="btn btn-primary" href="<?php echo site_url('admin/Inventory/add_inventory') ?>" style="float:right;">Add New Inventory Inspection</a>
		...
		<div class="row">
			<div class="col-lg-12">
				<form method="post" class="clearfix" action="<?php echo site_url('admin/Inventory');?>">
        ...
        <?php } ?>    
            <div class="table-responsive">
              <table class="table table-hover tablesorter">
                <thead>
                  <tr>
                    <th class="header">Inventory <i class="fa fa-sort"></i></th>
                ...
                <tbody>
                    ...
                    foreach($list as $key => $ass){
                      if($ass["ins_delete"] == 'N'){
                        ...
                        echo '<td><a href="'. base_url().'admin/inventory/edit_ins/'.$ass["insid"].'" class="btn btn-xs btn-success">edit</a>   <a href="'. base_url().'admin/inventory/get_ques/'.$ass["insid"].'" class="btn btn-xs btn-warning">add Inventory Question</a>  <a href="'. base_url().'admin/inventory/delete_ins/'.$ass["insid"].'" class="btn btn-xs btn-danger">delete</a></td>';
                        echo '</tr>';
                      }
                       }    }
                     ?>
