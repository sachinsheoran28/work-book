...
<div id="page-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-xs-12">
                <a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>admin/inventoryresults" style="float:right;">❮ Back</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach (explode(",", $list->scores) as $k => $score) {
                            $score_obtain = explode(",", $list->scores2)[$k];
                            ?>
                            <tr>
                                <td><?= $k + 1 ?></td>
                                ...
                                <td><?php echo $score_obtain != ' ' ? number_format($score_obtain) : '0'; ?></td>
                            </tr>
                        <?php } ?> 
                    </tbody>
                </table>
