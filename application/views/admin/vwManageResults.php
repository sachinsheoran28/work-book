...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1>Results <small>Manage Inspection Results</small></h1>
            <ol class="breadcrumb">
                <li><a href="Results"><i class="icon-dashboard"></i> Results</a></li>
                <li class="active"><i class="icon-file-alt"></i>Inspection Results List</li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>Search Result</h3>
            <form method="post" class="clearfix" action="<?php echo site_url('admin/results'); ?>">
                <select name="search_type" class="form-control" style="width:150px;float:left;">
                    <option value="results.rid" <?php if ($search_type == 'results.rid') {
    ...
    <div class="table-responsive">
        <table class="table table-hover tablesorter">
            ...
            <tbody>
                ...
                if (empty($list)) {
                           echo '<tr>';
                           echo '<td colspan="4">Not Inspection Resluts Found.</td>';
                            echo '</tr>';
                       } else { $limit++;
                    foreach ($list as $key => $ass) {
                        ...
                        if ($ass['pending'] == '0') {
                            echo '<td><a href="' . base_url() . 'admin/results/view_result/' . $ass["rid"] . '" class="btn btn-xs btn-success">View</a> <a href="' . base_url() . 'admin/results/report_result/' . $ass["rid"] . '" class="btn btn-xs btn-warning">Approve</a>  </td>';
                        } else {
                            echo '<td><a href="' . base_url() . 'admin/results/view_result/' . $ass["rid"] . '" class="btn btn-xs btn-success">View</a> Report Approved</td>';
                        }
                        echo '</tr>';
                    }
                }
