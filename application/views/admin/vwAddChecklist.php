...
?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Checklist <small><?php echo $result;?></small></h1>
            <ol class="breadcrumb">
              <li><a href="index"><i class="icon-dashboard"></i> Checklist</a></li>
              <li class="active"><i class="icon-file-alt"></i>Add Checklist</li>
...
?>
                        ...
                        <div class="form-group">
                                <button class="btn btn-lg btn-primary btn-block" type="submit">Add Checklist</button>
                          </div>
                    </form>
                </div>
