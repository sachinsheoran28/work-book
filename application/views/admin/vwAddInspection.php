    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="icon-file-alt"></i>Add  Inspection</li>
        ...
        <div class="col-lg-8">
            ...
            <form class="form-signin panel" method="post" action="">
                <div class="form-group">
                    <label>Client </label>
                    <div id="inspe"></div>
                    <select class="form-control client_id" required="" name="insaid">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="insname" required="" value="<?= set_value('insname') ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button class="btn btn-lg btn-primary btn-block" type="submit">Add Inspection</button>
                </div>
            </form>
        </div>
    </div>
