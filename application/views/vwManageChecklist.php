...
-->
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Checklist <small>View Checklist</small></h1>
            <ol class="breadcrumb">
				<li><a href="javascript:void(0);"><i class="icon-dashboard"></i> Checklist</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<form method="post" class="clearfix" action="<?php echo site_url('Checklist');?>">
                ...
                <tbody>
					...
					foreach($list as $key => $ass){
                      if($ass["ins_delete"] == 'Y'){
                        ...
                        echo '<td><a href="'. base_url().'checklist/get_ques/'.$ass["insid"].'" class="btn btn-xs btn-warning">View Checklist Question</a></td>';
                        echo '</tr>';
                      }
                      }   
                     ?>
