...
?>
    ...
    <script src="https://cdn.webrtc-experiment.com/gumadapter.js"></script>
		<script src="https://cdn.firebase.com/js/client/2.4.0/firebase.js"></script>	
         ...
         <section class="recordrtc">
             ...
             <input type="hidden" id="cid" name="cid" value="<?php if(isset($cid)){echo $cid;} ?>">
               <button id="startrec" style="text-align: center; display: none;">Start Streaming</button>
            <input type="hidden" class="recording-media" value="record-video">
                <input type="hidden" class="media-container-format" value="WebM">
            <div style="text-align: center; display: none;">
                <button id="upload-to-server" style="text-align: center; display: none;">Upload To Server</button>
            </div>  
            <video controls muted style="text-align: center; display:none;"></video>
        </section>
        ...
        <script>
            ...
            var recordingLocation = recordingDIV.querySelector('#latilong');
            var recordingcid = recordingDIV.querySelector('#cid');
  ...
  var constrts = {
    ...
    console.log(videoSource);
                captureUserMedia(constrts, function(videoStream) {
  ...
  var constrts = {
      ...
      video: {deviceId: videoSource ? {exact: videoSource} : undefined}
                ...
                captureUserMedia(constrts, function(audioVideoStream) {
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                makeXMLHttpRequest('https://mcd.glocalthinkers.in/index.php/videos/do_save/'+recordingLocation.value+'/'+recordingcid.value, formData, function(progress) {
...
function showPosition(position)
  {
   //   document.getElementById("latilong").value = 'lat: '+ position.coords.latitude+', lng:'+ position.coords.longitude;  
      document.getElementById("latilong").value = position.coords.latitude+'-'+position.coords.longitude; 
  }
        </script>
        <?php /*
       <script src="<?php echo HTTP_JS_PATH; ?>videoselect.js"></script>
       */ ?>
		<script src="<?php echo HTTP_JS_PATH; ?>video.js"></script>
   	</div>
